...
- **Actuator** — what applies the change: a pi coding agent plus a repo-local skill, running locally or in CI and opening a PR.
...
5. How will pi run the actuator (provider, model, credentials, and print-mode command), and what golden patterns should it follow?
